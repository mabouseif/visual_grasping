...
from utils import get_heightmap, get_input_tensors, get_prepared_img, transform_position_cam_to_global
...
with b0RemoteApi.RemoteApiClient('b0RemoteApi_V-REP','b0RemoteApi', timeout=5) as client:
    ...
    def open_gripper():
        ...
        motor_force = 100 # N
        client.simxSetJointForce(gripper_joint_handle, motor_force, client.simxServiceCall())
        client.simxSetJointTargetVelocity(gripper_joint_handle, motor_velocity, client.simxServiceCall())
        gripper_position = client.simxGetJointPosition(gripper_joint_handle, client.simxServiceCall())
    ...
    def close_gripper():
        ...
        client.simxSetJointTargetVelocity(gripper_joint_handle, motor_velocity, client.simxServiceCall())
        gripper_position = client.simxGetJointPosition(gripper_joint_handle, client.simxServiceCall())
        right_force_sensor_feedback= client.simxReadForceSensor(right_force_sensor_handle, client.simxServiceCall())
    ...
    def move_to_rand():
        ...
        random_position = [+1.1673e-01, +8.4720e-01, +3.8412e-01] # transform_position_cam_to_global(random_position)
