    ...
    with b0RemoteApi.RemoteApiClient('b0RemoteApi_V-REP','b0RemoteApi', timeout=5) as client:
        ...
        class Robot():
            ...
            def reset_cup(self):
                ...
                #         ((object_position[2] < self.workspace_limits[2][0]) or (object_position[2] > self.workspace_limits[2][1])):
                relObjHandle = -1
                position = [self.original_cup_position[0] + np.random.uniform(-0.05, 0.05), self.original_cup_position[1] + np.random.uniform(-0.1, 0.1), self.original_cup_position[2]] # [self.original_cup_position[0], self.original_cup_position[1], self.original_cup_position[2]]
