...
class Logger():
    ...
    def save_images(self, iteration, color_image, depth_image, mode):
        ...
        print('np.min(depth_image): {}'.format(np.min(depth_image)))
        print('np.max(depth_image): {}'.format(np.max(depth_image)))
    ...
    def save_heightmaps(self, iteration, color_heightmap, depth_heightmap, mode):
        ...
        print('np.min(depth_heightmap): {}'.format(np.min(depth_heightmap)))
        print('np.max(depth_heightmap): {}'.format(np.max(depth_heightmap)))
